<template>
  <div>
    ...
    <button type="button" class="mostrar detalles" @click="mostrarFormulario = !mostrarFormulario">
      {{ mostrarFormulario ? 'Ocultar detalles' : 'Mostrar detalles' }}
    </button>

    <div v-if="mostrarFormulario && lote.ubicacionLote" class="mini-formulario">
...
import {
  ...
  numeroLetrasEntero, numeroLetrasConNumeros
