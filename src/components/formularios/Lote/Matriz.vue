  ...
  <div class="modal">
    <div class="formulario-all-matriz-a">
      ...
      <select v-model="lote.matriz.distritoMatriz">
        ...
        <option v-for="d in distritosFiltrados" :key="d.id" :value="d.id">
          {{ d.nombre }}
        </option>
      </select>
      ...
      <input v-model.number="lote.matriz.areaMatrizHasMatriz" type="number" step="any" required />
      ...
      <input v-model="lote.matriz.unidadCatastralMatriz" type="text" required />

      <label>Urbanización Matriz:</label>
      <input v-model="lote.matriz.urbanizacionMatriz" type="text" required />

      <label>Compraventa Matriz:</label>
      <input v-model="lote.matriz.compraventaMatriz" type="text" required />

      <label>Situación Legal:</label>
      <input v-model="lote.matriz.situacionLegalMatriz" type="text" required />
    </div>
  </div>
</template>
