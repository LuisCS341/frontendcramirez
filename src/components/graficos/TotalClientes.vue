<template>
  <div class="summary-card-clientes-registrados">
    <div class="icon-text">
      ...
      <div class="text">
        <p class="title">Total de Clientes<br /> {{ fechaActual }}</p>
      </div>
    </div>
    <div class="count">
...
const clientesHoy = ref('');

onMounted(async () => {
  try {
    const response = await axios.get('https://backendcramirez.onrender.com/api/clientes/total-registrados')
