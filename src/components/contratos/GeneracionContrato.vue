...
const descargarWordT1 = async (cliente) => {
  try {
    ...
    const datos = {
      ...
      nombresApellidos: safeUpper(cliente.cliente.nombresApellidos?.replace(/\s+/g, ' ').replace(/\r?\n|\r/g, ' ').trim()),
      nacionalidad: safeUpper(cliente.cliente.nacionalidad),
      estadoCivil: safeUpper(cliente.cliente.estadoCivil),
      direccion: safeUpper(cliente.cliente.direccion),
      ocupacion: safeUpper(cliente.cliente.ocupacion),
      distrito: safeUpper(cliente.cliente.distrito),
      provincia: safeUpper(cliente.cliente.provincia),
      departamento: safeUpper(cliente.cliente.departamento),
      descripcionEstadoCivil: cliente.cliente.descripcionEstadoCivil ?? '-',

      idClienteConyuge: conyuge?.idClienteConyuge ?? '-',
      nombresApellidosConyuge: safeUpper(conyuge?.nombresApellidosConyuge),
      documentoIdentificacionConyuge: safeUpper(conyuge?.documentoIdentificacionConyuge),
      numeroIdentificacionConyuge: conyuge?.numeroIdentificacionConyuge ?? '-',
      ocupacionConyuge: safeUpper(conyuge?.ocupacionConyuge),
      direccionConyuge: safeUpper(conyuge?.direccionConyuge),
      distritoConyuge: safeUpper(conyuge?.distritoConyuge),
      provinciaConyuge: safeUpper(conyuge?.provinciaConyuge),
      departamentoConyuge: safeUpper(conyuge?.departamentoConyuge),

      idClienteCopropietarios: copropietario?.idClienteCopropietarios ?? '-',
      nombresApellidosCopropietarios: safeUpper(copropietario?.nombresApellidosCopropietarios),
      numeroIdentificacionCopropietarios: safeUpper(copropietario?.numeroIdentificacionCopropietarios),
      ocupacionCopropietarios: safeUpper(copropietario?.ocupacionCopropietarios),
      documentoIdentificacionCopropietarios: safeUpper(copropietario?.documentoIdentificacionCopropietarios),
      direccionCopropietarios: safeUpper(copropietario?.direccionCopropietarios),
      distritoCopropietarios: safeUpper(copropietario?.distritoCopropietarios),
      provinciaCopropietarios: safeUpper(copropietario?.provinciaCopropietarios),
      departamentoCopropietarios: safeUpper(copropietario?.departamentoCopropietarios),
      estadoCivilCopropietarios: safeUpper(copropietario?.estadoCivilCopropietarios),
      ...
      idLote: lote?.idLote ?? '-',
      contrato: safeUpper(lote?.contrato),
      tipoProyecto: safeUpper(lote?.tipoProyecto),
      manzana: safeUpper(lote?.manzana),
      representanteLegal: safeUpper(lote?.representanteLegalVendedor),
      empresaVende: safeUpper(lote?.empresaVende),
      rucVendedor: lote?.rucVendedor ?? '-',
      numCuenta: lote?.numCuenta ?? '-',
      cci: lote?.cci ?? '-',
      numeroPartidaPoderVendedor: lote?.numeroPartidaPoderVendedor ?? '-',
      direccionVendedor: safeUpper(lote?.direccionVendedor),
      ...
      costoLoteLetras: safeUpper(lote?.costoLoteLetras),
      areaLote: lote?.areaLote ? parseFloat(lote.areaLote).toFixed(2) : '-',
      areaLoteLetras: safeUpper(lote?.areaLoteLetras),
      ...
      cuotaInicialIncluyeSeparacionLetras: safeUpper(cuota?.cuotaInicialIncluyeSeparacionLetras),
      ...
      saldoLoteLetras: safeUpper(cuota?.saldoLoteLetras),
      ...
      montoCuotaLetras: safeUpper(cuota?.montoCuotas),
      cuotaPendientePago: cuota?.cuotaPendientePago ?? '-',
      letrasPendientePago: safeUpper(cuota?.letrasPendientePago),
